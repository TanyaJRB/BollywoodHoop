...
const navTextClass = computed<string>(() => {
  ...
  const baseClass =
    "text-black hover:bg-black hover:text-white font-sans font-thin text-xs rounded-md p-1 tracking-widest";
  const homeClass =
  ...
  const activePageClass =
    baseClass + " text-white bg-black shadow-lg shadow-dark-500/50";
